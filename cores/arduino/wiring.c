...
#ifdef __SAMD21E17L__
    // Clock SERCOM for Serial
    PM->APBCMASK.reg |= PM_APBCMASK_SERCOM0 | PM_APBCMASK_SERCOM1 | PM_APBCMASK_SERCOM2 | PM_APBCMASK_SERCOM3;

    // Clock TC/TCC for Pulse and Analog
    PM->APBCMASK.reg |= PM_APBCMASK_TCC0 | PM_APBCMASK_TCC1 | PM_APBCMASK_TCC2 | PM_APBCMASK_TCC3 | PM_APBCMASK_TC3 | PM_APBCMASK_TC4 | PM_APBCMASK_TC5;
#else
  // Clock SERCOM for Serial
...
// However, it really lowers the power consumption by a factor of 20 in low power mode (0.03mA vs 0.6mA)
    ...
    ADC->CTRLB.reg = ADC_CTRLB_PRESCALER_DIV64 | // Divide Clock by 512.   //CUSTOM/ADJUSTED
